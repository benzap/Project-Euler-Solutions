...
(def numvalue [8 2 22 97 38 15 0 40 0 75 4 5 7 78 52 12 50 77 91 8
...
(defn array-index [i j]
  (+ i (* j dimension)))

(defn array-val [i j]
  (numvalue (array-index i j)))

(defn soln-right-product []
  (for [j (range dimension) i (range (- dimension 4))]
    (apply * [(array-val i j)
              (array-val (+ i 1) j)
              (array-val (+ i 2) j)
              (array-val (+ i 3) j)
